...
test("no overlap on mobile", async ({ page }) => {
          ...
          items: [
            {
              ...
              badges: {
                items: [
                  {
                    badge_name: "Very Very Long Badge Name 1",
                    badge_image: { sm: "b1.png" },
                  },
                  {
                    badge_name: "Very Very Long Badge Name 2",
                    badge_image: { sm: "b2.png" },
                  },
                  {
                    badge_name: "Very Very Long Badge Name 3",
                    badge_image: { sm: "b3.png" },
                  },
                ],
              },
            },
  ...
  await page.screenshot({
    path: "e2e/screenshots/mobile-checkin-no-overlap.png",
  });
});
...
test("inline on mobile if short", async ({ page }) => {
          ...
          items: [
            {
              ...
              badges: {
                items: [{ badge_name: "B1", badge_image: { sm: "b1.png" } }],
              },
            },
          ],
        },
  ...
  await page.screenshot({
    path: "e2e/screenshots/mobile-checkin-short-inline.png",
  });
});
