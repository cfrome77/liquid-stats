...
describe('StatsService', () => {
  ...
  it('should memoize results', () => {
    const mockBeers: BeerCheckin[] = [
      {
        beer: { bid: 1, beer_name: 'Beer 1', beer_style: 'Style 1', beer_label: '', beer_abv: 5, beer_slug: '' },
        brewery: { brewery_id: 1, brewery_name: 'Brewery 1', brewery_label: '', country_name: 'USA', contact: {}, location: { brewery_state: 'CA', lat: 0, lng: 0 } },
        rating_score: 4,
